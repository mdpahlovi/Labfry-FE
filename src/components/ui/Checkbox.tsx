...
const Checkbox: React.FC<CheckboxProps> = ({ label, value = false, onChange, name, className = "", error }) => {
    return (
        <div className={`relative flex items-center ${className}`}>
            <input
                ...
                checked={value}
                onChange={onChange}
                className={`peer h-5 w-5 rounded border-2 border-gray-300 checked:border-[#EE3638] checked:bg-[#EE3638] appearance-none ${
            ...
            <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="peer-checked:block hidden absolute top-[3px] left-[3px]"
            >
                <path
